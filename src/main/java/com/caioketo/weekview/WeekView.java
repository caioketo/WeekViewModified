...
public class WeekView extends View {
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
        ...
        for (int i = 0; i < 24; i++) {
            ...
            if (top < getHeight()) {
                canvas.drawText(getTimeString(i), mTimeTextWidth + mHeaderColumnPadding, top + mTimeTextHeight, mTimeTextPaint);
    ...
    private String getDayName(int dayOfWeek) {
        if (Calendar.MONDAY == dayOfWeek) return "SEG";
        else if (Calendar.TUESDAY == dayOfWeek) return "TER";
        else if (Calendar.WEDNESDAY == dayOfWeek) return "QUA";
        else if (Calendar.THURSDAY == dayOfWeek) return "QUI";
        else if (Calendar.FRIDAY == dayOfWeek) return "SEX";
        else if (Calendar.SATURDAY == dayOfWeek) return "SAB";
        else if (Calendar.SUNDAY == dayOfWeek) return "DOM";
